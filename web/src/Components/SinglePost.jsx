...
export default function SinglePost() {
    ...
    useEffect(() => {
        const fetchSingleSharing = async () => {
            try {
                const response = await axiosInstance.get(`http://localhost:8585/api/sharings/get/${sharingId}`);
    ...
    useEffect(() => {
        const fetchComments = async () => {
            try {
                const response = await axiosInstance.get('http://localhost:8585/api/comments/get');
    ...
    const addNewComment = async (event) => {
        ...
        try {
            const response = await axiosInstance.post('http://localhost:8585/api/comments/createNew', newComment);
